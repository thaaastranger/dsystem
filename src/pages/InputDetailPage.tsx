...
export const InputDetailPage: React.FC<InputDetailPageProps> = ({ onBack, onBreadcrumbClick, onNavigateToList, onNavigateToFoundation, onNavigateToStatus }) => {
      ...
      {activeTab === 'Changelog' && (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          <section>
            ...
            <p style={{ fontSize: '14px', color: 'rgba(0,0,0,0.7)', marginTop: 0, marginBottom: '32px' }}>
              Track all changes and updates to the Input component.
            </p>
          </section>
          ...
          {[
            ...
            },
            {
              ...
              version: 'v1.0.0',
              changes: [
                { type: 'Added', description: 'Initial Input component implementation' },
                { type: 'Added', description: 'Label and helper text support' },
                { type: 'Added', description: 'Leading and trailing icon support' },
                  ...
                  <div key={changeIdx} style={{ display: 'flex', gap: '8px', fontSize: '14px' }}>
                    <span
                      style={{
                        ...
                        fontSize: '12px',
                        fontWeight: '500',
                        backgroundColor: change.type === 'Added' ? '#EEFAF3' : change.type === 'Changed' ? '#EDF4FF' : change.type === 'Fixed' ? '#FFF9EB' : '#FFF0F0',
                        color: change.type === 'Added' ? '#2E976E' : change.type === 'Changed' ? '#2170F0' : change.type === 'Fixed' ? '#E09E1F' : '#CC3333',
                      }}
                    >
                      {change.type}
                    </span>
