    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
      ...
      <section>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          {[
            { name: 'radi-1', value: '0px', label: 'None', usage: 'Sharp corners, no radius' },
            { name: 'radi-2', value: '2px', label: 'Extra Small', usage: 'Very subtle rounding' },
            { name: 'radi-3', value: '4px', label: 'Small', usage: 'Badges, tags, small elements' },
            { name: 'radi-4', value: '6px', label: 'Medium', usage: 'Buttons, inputs, cards' },
            { name: 'radi-5', value: '8px', label: 'Large', usage: 'Panels, modals, large cards' },
            { name: 'radi-6', value: '12px', label: 'Extra Large', usage: 'Feature cards, containers' },
            { name: 'radi-7', value: '16px', label: '2XL', usage: 'Large containers, sections' },
            { name: 'radi-8', value: '20px', label: '3XL', usage: 'Hero sections, major containers' },
            { name: 'radi-9', value: '24px', label: '4XL', usage: 'Large surfaces, special elements' },
            { name: 'radi-10', value: '28px', label: '5XL', usage: 'Extra large surfaces' },
            { name: 'radi-11', value: '32px', label: '6XL', usage: 'Very large containers' },
            { name: 'radi-12', value: '40px', label: '7XL', usage: 'Pill shapes, rounded containers' },
            { name: 'radi-13', value: '48px', label: '8XL', usage: 'Large pill shapes' },
            { name: 'radi-14', value: '56px', label: '9XL', usage: 'Extra large pill shapes' },
            { name: 'radi-15', value: '64px', label: '10XL', usage: 'Full pill/circular elements' },
          ].map((token) => {
            const radiusValue = parseInt(token.value);
            // Calculate appropriate dimensions for visual example
            const isLarge = radiusValue >= 16;
            const width = isLarge ? Math.max(200, radiusValue * 3.5) : 80;
            const height = isLarge ? 80 : 80;
            ...
            return (
              ...
              >
                ...
                <div style={{
                  ...
                  flexShrink: 0,
                  boxShadow: '0 2px 8px rgba(33, 112, 240, 0.15)',
                }} />
